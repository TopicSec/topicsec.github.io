...
In this example, we imagine a web application which seeks to allow you to view an image in your browser entirely client side.
In order to do so, it builds up html and writes it to the dom.
It uses a wasm function call to convert the image data into a raw image data URL.
