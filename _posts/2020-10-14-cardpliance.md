...
> Widespread adoption of online financial transactions in early 2000s lead to massive payments frauds. As a result in 2004 PCI (Payment Card Industry) released Data Security Standard aiming to secure credit card payments. PCI DSS distinguishes between two kinds of data impacting software processing - Cardholder Data (CHD) and Sensitive Account Data (SAD). CHD represents the cardholder whereas SAD authenticates the cardholder. SAD is not allowed to be written to any persistent storage.
