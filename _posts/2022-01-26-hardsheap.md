...
On a more meta level, we discussed the ability of program committees to champion a paper in order to shine a spotlight on a research area; being in an newer or underexamined area in the first place can be to the paper's own benefit in this regard.
...
-To summarize it, as we hve discussed - the paper is like a master class in how to take a relatively simple idea that was not explored before and present it as a new idea.
